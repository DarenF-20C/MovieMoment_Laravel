            ...
            <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <a href="{{ route('editPassword')}}" target="__blank" style="color:black;">
              ...
              <div class="row gutters-sm">
                <div class="col-sm-12 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Total Post: </i>{{$totalPost}}</h6>
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Total Comment: </i>{{$totalComment}}</h6>
                      <h6 class="d-flex align-items-center mb-3"><i class="material-icons text-info mr-2">Total Point: </i>{{$user->point}}</h6>
                    </div>
                  </div>
                </div>
              </div>
