          ...
          <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
              ...
              <div class="card mt-3">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap" id="link">
                    <a href="{{ route('userProfile')}}" class="links">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap" id="link">
                    <a href="{{ route('editPassword')}}"class="links">
